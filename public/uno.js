// The original cards.js was created by Einar Egilsson and is licensed under the MIT license.
// This version was modified by Calvin Lucido to work with cardtablejs.herokuapp.com
// The card images were created by Nicu Buculei and are in the public domain.
	...
	Container.prototype.extend({
		...
		addCards : function(cards) {
			for (var i = 0; i < cards.length;i++) {
				...
				this.push(card);
				card.container = this;
				card.el.off('click');   // deregister event listener
				card.el.click(onclick); // otherwise we'd get duplicate responses
			}
		},
